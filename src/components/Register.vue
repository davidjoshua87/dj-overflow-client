    ...
    <div class="register-board">
        ...
        <div>
            <span class="form-label">
                ...
                <span style="color:white;font-size:15px;" v-show="errors.has('username')"
                    class="help is-danger">{{ errors.first('username') }}</span>
                <!-- <label for="username">Username</label> -->
            </span>
            <span class="form-label">
                <input v-validate="'required|email'" v-model='email' type="text" name="email" placeholder="Email" />
                <span style="color:white;font-size:15px;" v-show="errors.has('email')"
            ...
            <span class="form-label">
                ...
                <span style="color:white;font-size:15px;" v-show="errors.has('password')"
                    ...
                    if (val) {
                        this.$http.post('/users', {
                            ...
                            .then(res => {
                                ...
                                swal({
                                    type: 'success',
                                    text: 'You are successful register and log in'
                                }).then((next) => {
                                    this.username = ' '
                                    this.email = ' '
                                    this.password = ' '
