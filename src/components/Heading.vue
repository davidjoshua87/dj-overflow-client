<template>
    <div class="contain">
        <div class="header">
            <div class="logo">
                <router-link to="/"><img src="@/assets/sologoedit.png" alt="" class="s" style="height:30px;"><span>
                        <h2>DJ Overflow</h2>
                    </span></router-link>
            </div>
            <div class="items" v-if="!checkToken" style="margin-top:auto; margin-bottom:auto;">&zwnj;</div>
            <div class="items" v-else style="margin-top:auto; margin-bottom:auto;">
                <router-link to='/myquestions'> My Questions</router-link>
            </div>
            <div class="login">
                <button v-if="!checkToken" @click='openlogin()' class="rad-button wwt flat" id="rad-button">Log
                    In</button>
